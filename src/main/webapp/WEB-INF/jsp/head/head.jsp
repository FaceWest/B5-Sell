				...
				<nav class="navbar navbar-expand-lg  navigation">
					...
					<div class="collapse navbar-collapse" id="navbarSupportedContent">
						...
						<ul class="navbar-nav ml-auto mt-10">
							<li class="nav-item" id="login"><a class="nav-link login-button"
								href="login">登录</a></li>
							<li class="nav-item"><a class="nav-link add-button" href="#"><i
									class="fa fa-plus-circle"></i> 注册</a></li>
						</ul>
					</div>
				</nav>
			</div>
